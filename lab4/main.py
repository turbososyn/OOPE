...
class ShapeEditorApp:
    def __init__(self, root):
        ...
        self.shape_menu.add_command(label="Куб", command=lambda: self.editor.set_mode("Cube"))
        self.shape_menu.add_command(label="Відрізок", command=lambda: self.editor.set_mode("Segment"))
        ...
        self.add_toolbar_button(self.create_cube_icon, "Cube", "Режим малювання куба")
        self.add_toolbar_button(self.create_segment_icon, "Segment", "Режим малювання відрізка")
    ...
    def create_cube_icon(self, canvas):
        canvas.create_rectangle(4, 4, 20, 20, outline="black")
        canvas.create_rectangle(6, 6, 18, 18, outline="black")

    def create_segment_icon(self, canvas):
        canvas.create_line(4, 4, 20, 20, fill="black")
        canvas.create_oval(18, 18, 22, 22, outline="black")
